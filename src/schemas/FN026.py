...
class FN026(FNBase):
    """Scrub our spaces.  Make sure that if either lat or lon is
    populated, so is the other.
    """
    ...
    _to_titlecase = field_validator("space_des",  mode="before")(to_titlecase)
    _to_uppercase = field_validator("space",  mode="before")(to_uppercase)
    ...
    _not_specified = field_validator("space_des", mode="before")(not_specified)
